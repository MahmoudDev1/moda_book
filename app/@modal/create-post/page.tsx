    ...
    <>
      ...
      <div className="modal rounded-md bg-white p-3 shadow-md">
        <div className="mb-3 pb-3 border-b flex justify-between items-center">
          ...
          <Link href="/" className="w-8 h-8 rounded-full flex justify-center items-center bg-gray-200 p-2">
            <Image src="assets/x.svg" alt="Close Modal" width={10} height={15} className="h-auto w-auto" />
          </Link>
        </div>
        <AddPost />
      </div>
